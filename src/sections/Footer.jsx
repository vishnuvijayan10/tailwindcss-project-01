    ...
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="text-white-400 sm:max-w-sm font-montserrat mt-6 text-base leading-7 ">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas, mollitia.</p>
